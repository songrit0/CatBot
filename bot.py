        ...
        if isinstance(ctx.channel, discord.TextChannel):
            ...
            if ctx.channel.name.startswith("การขาย-"):
                ...
                try:
                    ...
                    await ctx.channel.delete(reason="ลบห้องการขายหลังจากการขายเสร็จสิ้น")
                    print(f"✅ ลบห้องการขาย {ctx.channel.name} ({ctx.channel.id}) เรียบร้อยแล้ว")
                    
                except Exception as e:
                    print(f"❌ ไม่สามารถลบห้องได้: {e}")
            else:
                print(f"❌ ห้องนี้ไม่ใช่ห้องการขาย: {ctx.channel.name}")
            
        else:
            print(f"❌ ไม่สามารถลบห้องได้: ห้องนี้ไม่ใช่ TextChannel")
            
    except discord.Forbidden:
        print(f"❌ ไม่มีสิทธิ์ในการลบห้อง {ctx.channel.name}")
    except Exception as e:
